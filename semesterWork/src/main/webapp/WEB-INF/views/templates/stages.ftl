        ...
        <div class="container ">
            ...
            <div class="row stages-cont_img">
                <div class="offset-1 col-md-2">
                    <div class="row justify-content-center"><img src="/views/assets/main/1.png" alt="stages"></div>
                    <div class="row stages-cont_text center"><h6>1. Ваше обращение <span> ко мне </span></h6></div>
                </div>
                <div class="offset-2 col-md-2">
                    <div class="row justify-content-center"><img src="/views/assets/main/3.png" alt="stages"></div>
                ...
                <div class="offset-2 col-md-2 text-center">
                    <div class="row  justify-content-center"><img src="/views/assets/main/5.png" alt="stages"></div>
            ...
            <div class="row stages-cont_img">
                <div class="offset-3 col-md-2">
                    <div class="row justify-content-center"><img src="/views/assets/main/2.png" alt="stages"></div>
                    <div class="row stages-cont_text center"><h6>2. Выезд по указанному адресу или приезд <span>ко мне в
                    офис</span></h6>
                    </div>
                </div>
                <div class="offset-2 col-md-2">
                    <div class="row justify-content-center"><img src="/views/assets/main/4.png" alt="stages"></div>
